...
def main_run():
    ...
    FOCUSEE_STOCKS = get_stock_names_from_excel(EXCEL_PATH, FOCUSED_SHEET_NAME, FOCUSED_COLUMN_NAME)
    FOCUSED_STOCK_NAMES = []

    for col in FOCUSEE_STOCKS:
        FOCUSED_STOCK_NAMES.append(col)
    print(f"\n--- 取得關注的股票清單 ---", FOCUSED_STOCK_NAMES)
