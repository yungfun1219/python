...
def process_trading_days():
    """
    功能：讀取指定的 CSV 檔案，刪除 2025/11/27 之前的日期資料，
          並使用讀取成功的編碼器將結果寫回原檔案。
    - 整合了所有功能，遵循流程扁平化。
    """
    ...
    # --- 2. 獲取截止日期 (固定日期 2025/11/27) ---
    # 截止日期設為 2025/11/27，保留日期 >= 2025/11/27 的資料。
    CUTOFF_DATE_STR = '2025/11/27'
